            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-7 text-center text-md-left d-flex justify-content-center align-items-center">
                    ...
                    <div>
                        ...
                        <p class="lead">"Insert Subtitle"<br></p>
                        <p>Fun Fact: "Insert FunFact"<br></p>
                        <div class="btn-group d-flex flex-column flex-lg-row" role="group" style="margin: 0px;margin-right: 0px;">
                            ...
                            <a class="btn btn-primary" role="button" style="margin: 5px;margin-right: 5px;margin-left: 5px;" href="insertrecipeoftheday" target="_blank">Recipe of the Day</a></div>
